...
class AppController extends Controller
{
    ...
    public function beforeRender()
    {
        ...
        parent::beforeRender();
        if(!empty($this->request->data['ContactForm'])){
            if($this->Contact->save($this->request->data['ContactForm'])){
                $this->flashMsg('Check your message', 'info');
        ...
        $this->set([
            ...
            'namePage'          => $this->Page->find('first', ['conditions' => ['key' => $this->request->params['action']]]),
            'user'              => $user,
            'form_main'        => $this->CompanyContact->find('first', ['conditions'=> ['position ' => 'form']]),
        ]);
    }
