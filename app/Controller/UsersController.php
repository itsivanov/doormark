...
//        }
    ...
    public function profile()
    {
        if($this->Auth->login()){
            ...
            $userInfo = $this->Auth->user('Profile');
            $this->set(compact('userName', 'userInfo'));
        }

        if(!empty($this->request->data['ProfileMessage'])){
            if($this->Contact->save($this->request->data['ProfileMessage'])){
